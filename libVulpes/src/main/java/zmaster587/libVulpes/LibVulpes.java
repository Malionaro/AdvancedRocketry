...
import zmaster587.libVulpes.items.LegacyMetaBlockItem;
...
public class LibVulpes {
	...
	public LibVulpes() {
		...
		LibVulpesBlocks.blockLegacyHatch = new BlockLegacyHatch(net.minecraft.block.AbstractBlock.Properties.create(Material.IRON).hardnessAndResistance(3));
		LibVulpesBlocks.blockLegacyHatch.setRegistryName("hatch");
		LibVulpesBlocks.blockLegacyOre = new BlockLegacyMaterial(net.minecraft.block.AbstractBlock.Properties.create(Material.ROCK).hardnessAndResistance(4), "ORE");
		LibVulpesBlocks.blockLegacyOre.setRegistryName("ore0");
		LibVulpesBlocks.blockLegacyMetal = new BlockLegacyMaterial(net.minecraft.block.AbstractBlock.Properties.create(Material.IRON).hardnessAndResistance(4), "BLOCK");
		LibVulpesBlocks.blockLegacyMetal.setRegistryName("metal0");
		LibVulpesBlocks.blockLegacyCoil = new BlockLegacyMaterial(net.minecraft.block.AbstractBlock.Properties.create(Material.IRON).hardnessAndResistance(4), "COIL");
		LibVulpesBlocks.blockLegacyCoil.setRegistryName("coil0");
		...
		LibVulpesItems.itemLegacyHatch = new LegacyMetaBlockItem(LibVulpesBlocks.blockLegacyHatch, new Item.Properties(), BlockLegacyHatch.VARIANT).setRegistryName("hatch");
		LibVulpesItems.itemLegacyOre = new LegacyMetaBlockItem(LibVulpesBlocks.blockLegacyOre, new Item.Properties(), BlockLegacyMaterial.VARIANT).setRegistryName("ore0");
		LibVulpesItems.itemLegacyMetal = new LegacyMetaBlockItem(LibVulpesBlocks.blockLegacyMetal, new Item.Properties(), BlockLegacyMaterial.VARIANT).setRegistryName("metal0");
		LibVulpesItems.itemLegacyCoil = new LegacyMetaBlockItem(LibVulpesBlocks.blockLegacyCoil, new Item.Properties(), BlockLegacyMaterial.VARIANT).setRegistryName("coil0");
		String[] legacyProducts = {"productdust", "productingot", "productgem", "productboule",
				"productnugget", "productplate", "productstick", "productfan", "productsheet", "productgear"};
		LibVulpesItems.itemLegacyMaterialProducts = new Item[legacyProducts.length];
		for(int i = 0; i < legacyProducts.length; i++)
			LibVulpesItems.itemLegacyMaterialProducts[i] = new Item(new Item.Properties()).setRegistryName(legacyProducts[i]);
	...
	public void registerItems(RegistryEvent.Register<Item> evt) {
		...
		evt.getRegistry().registerAll(LibVulpesItems.itemLinker,
				...
				LibVulpesItems.itemLegacyHatch,
				LibVulpesItems.itemLegacyOre,
				LibVulpesItems.itemLegacyMetal,
				LibVulpesItems.itemLegacyCoil);
		evt.getRegistry().registerAll(LibVulpesItems.itemLegacyMaterialProducts);
	...
	public void registerBlocks(RegistryEvent.Register<Block> evt) {
		...
		r.register(LibVulpesBlocks.blockLegacyHatch);
		r.register(LibVulpesBlocks.blockLegacyOre);
		r.register(LibVulpesBlocks.blockLegacyMetal);
		r.register(LibVulpesBlocks.blockLegacyCoil);
	...
	@SubscribeEvent(priority=EventPriority.HIGH)
	public void missingItemMappings(RegistryEvent.MissingMappings<Item> evt) {
	...
	@SubscribeEvent(priority=EventPriority.HIGH)
	public void missingBlockMappings(RegistryEvent.MissingMappings<Block> evt) {
		for(RegistryEvent.MissingMappings.Mapping<Block> mapping : evt.getAllMappings()) {
			if(!MODID.equals(mapping.key.getNamespace()))
				continue;
	...
	@SubscribeEvent(priority=EventPriority.HIGH)
	public void missingTileMappings(RegistryEvent.MissingMappings<TileEntityType<?>> evt) {
		for(RegistryEvent.MissingMappings.Mapping<TileEntityType<?>> mapping : evt.getAllMappings()) {
			if(!MODID.equals(mapping.key.getNamespace()))
				continue;

			TileEntityType<?> target;
			switch(mapping.key.getPath()) {
				case "vulpesoutputhatch": target = LibVulpesTileEntityTypes.TILE_OUTPUT_HATCH; break;
				case "vulpesinputhatch": target = LibVulpesTileEntityTypes.TILE_INPUT_HATCH; break;
				case "vulpesplaceholder": target = LibVulpesTileEntityTypes.TILE_PLACEHOLDER; break;
				case "vulpestileschematic": target = LibVulpesTileEntityTypes.TILE_SCHEMATIC; break;
				case "vulpescreativebattery": target = LibVulpesTileEntityTypes.TILE_CREATIVE_BATTERY; break;
				case "vulpesforgepowerinput": target = LibVulpesTileEntityTypes.TILE_FORGE_POWER_INPUT; break;
				case "vulpesforgepoweroutput": target = LibVulpesTileEntityTypes.TILE_FORGE_POWER_OUTPUT; break;
				case "vulpescoalgenerator": target = LibVulpesTileEntityTypes.TILE_COAL_GENERATOR; break;
				case "vulpestilepointer": target = LibVulpesTileEntityTypes.TILE_POINTER; break;
				default: target = null;
			}
			if(target != null)
				mapping.remap(target);
	...
	private static Block legacyBlockTarget(String oldPath) {
		switch(oldPath) {
			case "blockphantom": return LibVulpesBlocks.blockPhantom;
			case "placeholder": return LibVulpesBlocks.blockPlaceHolder;
			case "structuremachine": return LibVulpesBlocks.blockMachineStructure;
			case "advstructuremachine": return LibVulpesBlocks.blockAdvancedMachineStructure;
			case "creativepowerbattery": return LibVulpesBlocks.blockCreativeInputPlug;
			case "forgepowerinput": return LibVulpesBlocks.blockForgeInputPlug;
			case "forgepoweroutput": return LibVulpesBlocks.blockForgeOutputPlug;
			case "coalgenerator": return LibVulpesBlocks.blockCoalGenerator;
			case "advancedmotor": return LibVulpesBlocks.blockAdvancedMotor;
			case "enhancedmotor": return LibVulpesBlocks.blockEnhancedMotor;
			case "elitemotor": return LibVulpesBlocks.blockEliteMotor;
			default: return null;
		}
	}

	private static Item legacyItemTarget(String oldPath) {
		switch(oldPath) {
			case "productcrystal":
				return MaterialRegistry.getItemStackFromMaterialAndType("dilithium", AllowedProducts.getProductByName("GEM")).getItem();
			case "holoprojector": return LibVulpesItems.itemHoloProjector;
			case "structuremachine": return LibVulpesItems.itemMachineStructure;
			case "advstructuremachine": return LibVulpesItems.itemAdvancedMachineStructure;
			case "creativepowerbattery": return LibVulpesItems.itemCreativeInputPlug;
			case "forgepowerinput": return LibVulpesItems.itemForgeInputPlug;
			case "forgepoweroutput": return LibVulpesItems.itemForgeOutputPlug;
			case "coalgenerator": return LibVulpesItems.itemCoalGenerator;
			case "advancedmotor": return LibVulpesItems.itemAdvancedMotor;
			case "enhancedmotor": return LibVulpesItems.itemEnhancedMotor;
			case "elitemotor": return LibVulpesItems.itemEliteMotor;
			default: return null;
		}
	}
	...
	private void registerBlockTypes() {
		...
		list.add(new BlockMeta(LibVulpesBlocks.blockItemOutputHatch.getDefaultState(), true));
		list.add(new BlockMeta(LibVulpesBlocks.blockLegacyHatch.getDefaultState(), true));
