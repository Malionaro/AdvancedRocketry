...
public class LibVulpesBlocks {
	...
	public static BlockLegacyHatch blockLegacyHatch;
	public static BlockLegacyMaterial blockLegacyOre;
	public static BlockLegacyMaterial blockLegacyMetal;
	public static BlockLegacyMaterial blockLegacyCoil;
